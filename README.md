...
| `vendored-skills` | [marceloeatworld/nixos-ai-skill](https://github.com/marceloeatworld/nixos-ai-skill), [vercel-labs/skills](https://github.com/vercel-labs/skills), [wshobson/agents](https://github.com/wshobson/agents), one file from [github/awesome-copilot](https://github.com/github/awesome-copilot) | 19 |
...
- The four skill sources are flake inputs; the lock is bumped by the workflow, not by hand.
